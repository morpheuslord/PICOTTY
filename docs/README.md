...
| [dual-hub.md](dual-hub.md) | Dual-hub failover: a primary + backup hub per node, runtime steering (move / set-home / pin), the independent-peers model, and the shared node token |
