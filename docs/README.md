...
| [dual-hub.md](dual-hub.md) | Dual-hub failover: a primary + backup hub per node, runtime steering (move / set-home / pin), cross-hub takeover from either hub (`HUB_PEERS`), the independent-peers model, and the shared node token |
